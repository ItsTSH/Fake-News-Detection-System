...
export const About = () => {
  return (
      ...
      <div className="rounded-lg p-6 mb-8">
        <h1 className="text-3xl font-bold text-blue-600 mb-6 text-center">About Our Fake News Detection Project</h1>
        
        {/* Introduction Section */}
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 dark:text-slate-400 mb-4">Introduction to the Project</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 dark:text-slate-400 mb-4">Proposed Solution</h2>
          <div className="bg-blue-50 dark:bg-slate-800 p-4 rounded-lg mb-4">
            <p className="text-gray-700 dark:text-slate-400 mb-4">
            ...
            <ul className="list-disc list-inside mt-2 ml-4 text-gray-700 dark:text-slate-400">
          ...
          <p className="text-gray-700 dark:text-slate-400">
            Our model has achieved a classification accuracy of upto 90%, making it a robust tool for identifying potential 
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 dark:text-slate-400 mb-4">System Architecture</h2>
          <div className="grid md:grid-cols-3 gap-4 mb-4">
            <div className="bg-green-50 dark:bg-green-800 p-4 rounded-lg">
              <h3 className="text-xl font-medium text-green-800 dark:text-green-400 mb-2">Backend</h3>
            ...
            <div className="bg-purple-50 dark:bg-purple-800 p-4 rounded-lg">
              <h3 className="text-xl font-medium text-purple-800 dark:text-purple-400 mb-2">ML Component</h3>
              <p className="text-gray-700 dark:text-slate-400">
          ...
          <div className="bg-gray-50 dark:bg-slate-800 p-4 rounded-lg">
            <h3 className="text-xl font-medium text-gray-800 dark:text-slate-300 mb-2">System Flow</h3>
            <p className="text-gray-700 dark:text-slate-400 mb-2">
              The system operates through the following process:
            </p>
            <ol className="list-decimal list-inside ml-4 text-gray-700 dark:text-slate-400">
        ...
        {/* FAQ Section */}
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 dark:text-slate-400 mb-4">Frequently Asked Questions</h2>
          
          <div className="space-y-4">
            <div>
              <h3 className="text-lg font-medium text-blue-600">How accurate is the fake news detection model?</h3>
            ...
            <div>
              <h3 className="text-lg font-medium text-blue-600">What types of content can be analyzed?</h3>
              <p className="text-gray-700 dark:text-slate-400 mt-1">
            ...
            <div>
              <h3 className="text-lg font-medium text-blue-600">How does the BERT model identify fake news?</h3>
              <p className="text-gray-700 dark:text-slate-400 mt-1">
            ...
            <div>
              <h3 className="text-lg font-medium text-blue-600">Is my submitted content stored or shared?</h3>
              <p className="text-gray-700 dark:text-slate-400 mt-1">
            ...
            <div>
              <h3 className="text-lg font-medium text-blue-600">Can the system be fooled?</h3>
              <p className="text-gray-700 dark:text-slate-400 mt-1">
        ...
        {/* Conclusion Section */}
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 dark:text-slate-400 mb-4">Conclusion</h2>
          <p className="text-gray-700 dark:text-slate-400 mb-4">
        ...
        {/* References Section */}
        <section>
          <h2 className="text-2xl font-semibold text-gray-800 dark:text-slate-400 mb-4">References</h2>
          <div className="bg-gray-50 p-4 rounded-lg dark:bg-gray-800">
            <ul className="list-disc list-inside ml-4 text-gray-700 dark:text-slate-400 space-y-2">
              <li>
